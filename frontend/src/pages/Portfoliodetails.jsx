...
import portfolio_banner from '../assets/img/portfolio_banner.jpg';
import portfolio_img_10 from '../assets/img/portfolio_img_10.jpg';
import portfolio_img_11 from '../assets/img/portfolio_img_11.jpg';
        ...
        <section>
            ...
            <div className="container">
                <div className="cs_portfolio_details">
                    <img src={portfolio_banner} alt="Portfolio Banner" />
                        ...
                        <div className="col-xl-8 col-lg-7">
                            ...
                            <div className="row cs_row_gap_30">
                                <div className="col-md-6">
                                    <img src={portfolio_img_10} alt="Portfolio Image" />
                                </div>
                                <div className="col-md-6">
                                    <img src={portfolio_img_11} alt="Portfolio Image" />
                                </div>
                            </div>
